                                ...
                                <div class="w3-col s12 w3-center">
                                    <div class="w3-xxlarge w3-wide" style="padding-top:25px;">
                                        ...
                                        <div class="w3-text-grey w3-xlarge _w3-margin-top">
                                            <i id="compare-indicator-${i + 1}" class="fa fa-circle${COMPARE_PICKS_2.indexOf(s) >= 0 ? '-o' : ''} w3-text-${COMPARE_PICKS.indexOf(s) >= 0 ? 'lightgrey' : (COMPARE_PICKS_2.indexOf(s) >= 0 ?  'orange' : 'white')}"></i>
