...
const COMPARE_PICKS = 'AMAT,ASML,BTSG,HTLD,KLAC,LRCX,WLDN'.split(',');
const COMPARE_PICKS_2 = 'ARM,CRWD,DDOG,DRAM,MRVL,MU,SMCI,SNDK,SOXL,STX,UMC,WDC'.split(',');
const COMPARE_DEFAULT_SYMBOLS = [
    ...'NQ=F,QQQ,CL=F,^VIX'.split(','),
    // ...'AMAT,ASML,BTSG,HTLD,KLAC,LRCX,WLDN'.split(','),
    ...COMPARE_PICKS,
    ...COMPARE_PICKS_2,
    ...'AMD,ARM,AVGO,CIFR,COHR,CRM,CRDO,CRWD,DDOG,DRAM,LASR,LITE,MRVL,MU,PENG,UMC,SMCI,SNDK,SOXL,STRL,STX,WDC,WOLF,WULF'.split(',').sort()
];
...
const COMPARISON_NUM_DAYS = () => {
    ...
    return dow === 0 ? 3 : (dow === 6 ? 1.75 : 0.25);
    // return 3;
}
